...
static as5600_err_t as5600_adc_get_conversion(as5600_t const* as5600,
                                              uint16_t* conversion)
{
    return as5600->interface.adc_get_conversion
               ? as5600->interface.adc_get_conversion(
                     as5600->interface.adc_user,
                     conversion)
               : AS5600_ERR_NULL;
}
...
static as5600_err_t as5600_gpio_deinitialize(as5600_t const* as5600)
{
    return as5600->interface.gpio_deinitialize
               ? as5600->interface.gpio_deinitialize(
                     as5600->interface.gpio_user)
               : AS5600_ERR_NULL;
}

static as5600_err_t as5600_gpio_write_pin(as5600_t const* as5600,
                                          uint32_t pin,
                                          bool state)
{
    return as5600->interface.gpio_write_pin
               ? as5600->interface.gpio_write_pin(as5600->interface.gpio_user,
                                                  pin,
                                                  state)
               : AS5600_ERR_NULL;
}
...
as5600_err_t as5600_set_direction(as5600_t const* as5600,
                                  as5600_direction_t direction)
{
    assert(as5600);

    return as5600_gpio_write_pin(as5600,
                                 as5600->config.dir_pin,
                                 direction & 0x01U);
}

as5600_err_t as5600_get_angle_data_scaled_adc(as5600_t const* as5600,
                                              float32_t* scaled)
{
    ...
    *scaled = (float32_t)raw *
                  (as5600->config.max_angle - as5600->config.min_angle) /
                  4096.0F +
...
as5600_err_t as5600_get_angle_data_raw_adc(as5600_t const* as5600,
                                           uint16_t* raw)
{
    assert(as5600 && raw);
...
as5600_err_t as5600_get_angle_data_scaled_bus(as5600_t const* as5600,
                                              float32_t* scaled)
{
    assert(as5600 && scaled);
...
as5600_err_t as5600_get_angle_data_raw_bus(as5600_t const* as5600,
                                           uint16_t* raw)
{
    assert(as5600 && raw);
...
as5600_err_t as5600_get_zmco_reg(as5600_t const* as5600, as5600_zmco_reg_t* reg)
{
    ...
    as5600_err_t err = as5600_bus_read_data(as5600,
                                            AS5600_REG_ADDRESS_ZMCO,
                                            &data,
                                            sizeof(data));
...
as5600_err_t as5600_set_zpos_reg(as5600_t const* as5600,
                                 as5600_zpos_reg_t const* reg)
{
    assert(as5600 && reg);
    ...
    err |= as5600_bus_write_data(as5600,
                                 AS5600_REG_ADDRESS_ZPOS_H,
                                 data,
                                 sizeof(data));
...
as5600_err_t as5600_set_mpos_reg(as5600_t const* as5600,
                                 as5600_mpos_reg_t const* reg)
{
    assert(as5600 && reg);
...
as5600_err_t as5600_set_mang_reg(as5600_t const* as5600,
                                 as5600_mang_reg_t const* reg)
{
    assert(as5600 && reg);
...
as5600_err_t as5600_set_conf_reg(as5600_t const* as5600,
                                 as5600_conf_reg_t const* reg)
{
    assert(as5600 && reg);
...
as5600_err_t as5600_get_raw_angle_reg(as5600_t const* as5600,
                                      as5600_raw_angle_reg_t* reg)
{
    assert(as5600 && reg);
    ...
    as5600_err_t err = as5600_bus_read_data(as5600,
                                            AS5600_REG_ADDRESS_RAW_ANGLE_H,
                                            data,
                                            sizeof(data));
...
as5600_err_t as5600_get_angle_reg(as5600_t const* as5600,
                                  as5600_angle_reg_t* reg)
{
    assert(as5600 && reg);
...
as5600_err_t as5600_get_status_reg(as5600_t const* as5600,
                                   as5600_status_reg_t* reg)
{
    assert(as5600 && reg);
...
as5600_err_t as5600_get_magnitude_reg(as5600_t const* as5600,
                                      as5600_magnitude_reg_t* reg)
{
    assert(as5600 && reg);
    ...
    as5600_err_t err = as5600_bus_read_data(as5600,
                                            AS5600_REG_ADDRESS_MAGNITUDE_H,
                                            data,
                                            sizeof(data));
